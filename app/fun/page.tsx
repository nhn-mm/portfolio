      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="bg-dark-800 rounded-lg p-6 mb-8">
          ...
          <ul className="space-y-3 text-light-300">
            ...
            <li className="flex items-start gap-2">
              <span>👆</span>
              <span>Click an egg when you find it — it&apos;ll change to confirm</span>
            </li>
            <li className="flex items-start gap-2">
              <span>🔀</span>
          ...
          <div className="space-y-6">
            <div className="bg-dark-800 rounded-lg p-6">
              ...
              <p className="text-sm text-light-400">
                Scroll through the homepage to find the hidden eggs. They could be anywhere!
              </p>
            </div>
            ...
            {allFound && (
              <div className="bg-dark-800 border border-accent-500 rounded-lg p-6 text-center">
                ...
                <p className="text-light-300 mt-2">
                  You found all the eggs! The game will reset in a few seconds...
                </p>
              </div>
            )}
          </div>
